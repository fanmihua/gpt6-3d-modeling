...
/* 厂区和泵房共用一套演示数据。照片模型与 CAD 泵房建立演示关联，不代表实测设备配置。 */
window.DEMO_DATA = {
  plant: {
  ...
  alarms:[
    {id:'AL-004',zoneId:'workshop',deviceId:'P-03',device:'3号泵',time:'10:22:14',title:'电机温度偏高',level:'high',value:'86.3 ℃',threshold:'≥80 ℃',excess:'6.3 ℃',description:'送水机房 P-03 电机机壳测点温度为86.3℃，超过演示阈值6.3℃。可由厂区进入泵房并查看关联电机部件；内部零件尚未诊断损坏。',acknowledged:false},
