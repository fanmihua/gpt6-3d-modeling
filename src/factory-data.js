...
export const FACTORY = {
  ...
  modelNote: '依据实拍照片重建厂区外观与布局，功能分区及尺寸为视觉推定。',
...
export const ZONES = [
  ...
  },
  {
    ...
    description: '对应照片中后部的方形处理池与设备廊道。滤池编号与差压测点为演示配置，可从事件定位区域。',
  ...
  },
  {
    ...
    description: '对应照片右前方的长条形工业建筑；送水功能为示意映射。区域包含泵房 P-03 电机温度演示告警，可继续查看机壳测点。',
